...
const AddAlbumDialog = () => {
   ...
   const handleSubmit = async () => {
		...
		try {
			...
			formData.append("title", newAlbum.title); //add title from newAlbum to formData
			formData.append("artist", newAlbum.artist); //add artist from newAlbum to formData
			formData.append("releaseYear", newAlbum.releaseYear.toString()); //add releaseYear from newAlbum to formData
			formData.append("imageFile", imageFile); //add imageFile to formData
